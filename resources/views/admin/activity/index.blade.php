        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h2 class="font-black text-3xl text-slate-900 tracking-tight font-display">
                    {{ __('Évolution & Historique d\'Activité') }}
                </h2>
                <p class="text-slate-600 font-medium mt-1">Suivez en temps réel les changements de configuration, les ventes et les actions d'administration.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="container-app space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-black text-slate-900 mt-1">E-mail (100%)</div>
                    </div>
                </div>
                ...
                <div class="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-xs text-slate-500 font-bold uppercase tracking-wider">Type de Suivi</div>
                        <div class="text-2xl font-black text-slate-900 mt-1">Sécurisé & Audit</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-premium p-8 sm:p-12">
                <h3 class="text-xl font-black text-slate-900 tracking-tight mb-8">Journal Temporel des Évolutions</h3>
