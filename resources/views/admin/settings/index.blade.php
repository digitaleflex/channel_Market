                ...
                <div class="card-cyber p-8">
                    <form action="{{ route('admin.settings.update') }}" method="POST">
                        ...
                        <div class="space-y-8">
                            <!-- Meta Pixel -->
                            <div>
                                <label for="meta_pixel_id" class="block text-sm font-black text-slate-800 uppercase tracking-wider mb-3">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="meta_pixel_id" id="meta_pixel_id" 
                                           class="input-cyber pl-12 w-full" 
                            ...
                            <!-- Google Analytics -->
                            <div>
                                <label for="google_analytics_id" class="block text-sm font-black text-slate-800 uppercase tracking-wider mb-3">
                            ...
                            <div class="pt-4">
                                <button type="submit" class="btn-cyber-primary w-full flex items-center justify-center gap-2 py-4">
