    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                ...
                <p class="text-slate-600 font-medium mt-1">Mise à jour de : {{ $product->title }}</p>
            </div>
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-8 sm:p-12" x-data="{ productType: '{{ $isLink ? 'link' : 'file' }}' }">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                <label class="block text-xs font-black uppercase tracking-widest text-slate-500 mb-3">Image de présentation</label>
                                <div class="space-y-4">
                                    @if($product->image)
                                    ...
                                    @endif
                                    <input type="file" name="image_file" class="w-full text-sm text-slate-600 file:mr-4 file:py-2.5 file:px-6 file:rounded-xl file:border-0 file:text-xs file:font-black file:bg-slate-900 file:text-white hover:file:bg-slate-800 cursor-pointer transition shadow-lg shadow-slate-900/10">
                                </div>
