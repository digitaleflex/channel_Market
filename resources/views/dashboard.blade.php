    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-slate-600 font-medium mt-1">Gérez vos produits numériques et vos téléchargements.</p>
            </div>
            ...
            <div class="surface p-8 md:p-12">
                            ...
                            <div class="card-premium group">
                                <div class="p-6">
                                    <div class="flex items-center gap-2 mb-4">
                                        ...
                                        <span class="text-[10px] font-black text-slate-500 uppercase tracking-widest">Digital Asset</span>
                                    </div>
                                    ...
                                    <p class="text-sm text-slate-500 font-bold mb-8 flex items-center gap-2">
                ...
                @else
                    <div class="text-center py-20 px-6">
                        ...
                        <p class="text-slate-600 font-medium mb-10 max-w-sm mx-auto">Explorez notre boutique pour trouver des produits numériques incroyables.</p>
